...
Public Class dashboard2
    ...
    End Sub
    Protected Sub Registersupplier()
        ...
        If myReader.Read = True Then
            ...
            If register = "0" Then
                Response.Write("<script>alert('Akun Belum Terdaftar. Silahkan daftar Terlebih dahulu')</script>")
                Response.Write("<script> window.open('../back-end/register.aspx', '_self'); </script>")
            End If
        End If
    End Sub
