<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="stok_masuk.aspx.vb" Inherits="Sistem_Inventory.stok_masuk" %>
                ...
                <div class="nav-link d-flex">
                  ...
                  <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                        <asp:PlaceHolder ID="PlaceHolderchangepass" Visible="true" runat="server">
   ...
   <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Menu Laporan Stok | Stok Masuk</h3>
